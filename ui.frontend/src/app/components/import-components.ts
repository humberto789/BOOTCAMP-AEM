 ...
 */
MapTo('bootcamp-aem/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('bootcamp-aem/components/separator')(SeparatorV1Component);

MapTo('bootcamp-aem/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('bootcamp-aem/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('bootcamp-aem/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('bootcamp-aem/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('bootcamp-aem/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('bootcamp-aem/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('bootcamp-aem/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('bootcamp-aem/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('bootcamp-aem/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('bootcamp-aem/components/accordion')(AccordionV1Component);
MapTo('bootcamp-aem/components/tabs')(TabsV1Component);
...
LazyMapTo('bootcamp-aem/components/teaser')(TeaserV1Component);
...
LazyMapTo('bootcamp-aem/components/carousel')(CarouselV1Component);
...
LazyMapTo('bootcamp-aem/components/text')(LazyTextModule, TextEditConfig);